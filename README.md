...
| [`engineering`](skills/engineering/) | General programming methodology skills, plus narrow engineering artifact-authoring workflows (e.g. Dev Container artifacts) | Per project, as needed |
