#!/usr/bin/env python3
"""Read-only GitLab reader for the REST fallback tier of gitlab-ops.
...
def _headers() -> dict:
    headers = {
        ...
        "User-Agent": "gitlab-ops-rest-read",
    }
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Last-resort read tier: prefer an authenticated glab CLI or a "
