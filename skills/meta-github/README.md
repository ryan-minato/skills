...
| [github-pr-conventions](github-pr-conventions/) | Author a repository's pull-request conventions: PR template, contributing rules, auto-labeling and checklist-validation workflows, and a generated project-level PR skill — with an AGENTS.md section as the fallback deliverable. |
