...
**artifact-authoring** workflows (e.g. Dev Container artifacts) that do
not warrant a catalog of their own. Community skills author policy and
structure; performing the day-to-day platform operations belongs to the
`ops` catalog.
