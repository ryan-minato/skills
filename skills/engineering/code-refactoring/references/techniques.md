...
**Preserve Whole Object** — counterpart tension: Replace Parameter with Query.
...
**Replace Type Code with Subclasses** — inverse: Remove Subclass.
...
**Remove Subclass** — inverse: Replace Type Code with Subclasses.
...
**Extract Superclass** — related: Collapse Hierarchy undoes a pointless one.
...
**Replace Subclass with Delegate** — see also Replace Superclass with Delegate.
