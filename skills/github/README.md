...
| [github-repo-research](github-repo-research/) | Read-only investigation of GitHub Discussions and Actions runs, with copy-paste GraphQL recipes for the gh path and a failed-log digest script that keeps huge logs out of context. |
