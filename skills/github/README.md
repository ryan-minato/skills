...
| [github-planning](github-planning/) | Milestone lifecycle via the REST API (gh has no milestone command), label lifecycle including rename and cross-repo clone, and Projects v2 — projects, items, Status and other fields — with the project token scope handled up front and a bundled node-ID resolver for item edits. |
| [github-releases](github-releases/) | Releases and tags through a draft-first flow — version pick via a bundled semver script, generated or hand-written notes, assets, review gate before publish — plus edit, prerelease/latest handling, and cleanup, with annotated-tag support. |
